...
export default function HodProfilePage() {
  ...
  const fullName = profile
    ? `${profile.prefix ? profile.prefix + " " : ""}${profile.first_name || profile.name || "HOD"} ${profile.last_name || ""}`.trim()
    : "HOD";
  ...
  return (
    <div className={styles.container}>
      <div className={styles.topBar}>
        <div>
          <h1 className={styles.title}>Department HOD Profile</h1>
      ...
      {loading ? (
        <p style={{ textAlign: "center", color: "#64748b", padding: "40px 0" }}>
          Loading HOD profile records from database...
        </p>
      ) : !profile ? (
        <div style={{ textAlign: "center", color: "#64748b", padding: "40px 0" }}>
          <User size={40} color="#cbd5e1" style={{ margin: "0 auto 10px" }} />
          <p>Unable to load HOD profile record.</p>
        </div>
      ) : (
          ...
          >
            ...
            <div>
              ...
              >
                ...
                >
                  Head of Department (HOD) • {profile.department_code || "Department"}
                </span>
                <span
                  style={{
                    background: "#eff6ff",
            ...
            <div className={styles.cardSection}>
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: "12px", fontSize: "13.5px" }}>
                ...
                <div style={{ display: "flex", justifyContent: "space-between", borderBottom: "1px solid #f1f5f9", paddingBottom: "8px" }}>
                  ...
                  <strong style={{ color: "#0b1d3a" }}>{profile.role_type || "Hod"}</strong>
                </div>
            ...
            <div className={styles.cardSection}>
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: "12px", fontSize: "13.5px" }}>
                ...
                <div style={{ display: "flex", justifyContent: "space-between", borderBottom: "1px solid #f1f5f9", paddingBottom: "8px" }}>
                  ...
                  <strong style={{ color: "#0b1d3a" }}>{profile.designation || "Head of Department"}</strong>
                </div>
                <div style={{ display: "flex", justifyContent: "space-between", borderBottom: "1px solid #f1f5f9", paddingBottom: "8px" }}>
            ...
            <div className={styles.cardSection}>
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: "12px", fontSize: "13.5px" }}>
                <div style={{ display: "flex", justifyContent: "space-between", borderBottom: "1px solid #f1f5f9", paddingBottom: "8px" }}>
                  ...
                  <strong style={{ color: "#0b1d3a" }}>{profile.highest_qualification || "Ph.D / M.E."}</strong>
                </div>
                <div style={{ display: "flex", justifyContent: "space-between", borderBottom: "1px solid #f1f5f9", paddingBottom: "8px" }}>
