    ...
    <div className={styles.container}>
      <div className={styles.header}>
        ...
        <div className={styles.actions}>
          ...
          <button
            ...
            type="button"
            onClick={() => router.push(`/hod/students/edit/${id}`)}
          >
      ...
      <div className={styles.printContent}>
        ...
        <div className={styles.printFooter}>
          Generated via NICETECH ERP System on {new Date().toLocaleDateString("en-IN", { day: "2-digit", month: "short", year: "numeric" })} at {new Date().toLocaleTimeString("en-IN", { hour: "2-digit", minute: "2-digit", second: "2-digit", hour12: true })} | Student Profile Document
        </div>
      </div>
    </div>
  );
