...
export default function EditStudent() {
      ...
      try {
        ...
        if (response.data.success) {
          ...
          setFormData({
            ...
            seven_point_five: data.seven_point_five || false,
            guardian_name: data.guardian_name || "",
            guardian_relationship: data.guardian_relationship || "",
            guardian_mobile: data.guardian_mobile || "",
            guardian_occupation: data.guardian_occupation || "",
            qualification: {
              emis_number: data.qualification?.emis_number || "",
              institution: data.qualification?.institution || "",
              qualifying_exam: data.qualification?.qualifying_exam || "",
              passing_year: data.qualification?.passing_year || "",
              register_number: data.qualification?.register_number || "",
              total_marks: data.qualification?.total_marks || "",
              mathematics_marks: data.qualification?.mathematics_marks || "",
              physics_marks: data.qualification?.physics_marks || "",
              chemistry_marks: data.qualification?.chemistry_marks || "",
              aggregate: data.qualification?.aggregate || "",
              eligibility: data.qualification?.eligibility || "",
              umis_number: data.qualification?.umis_number || "",
              diploma_branch: data.qualification?.diploma_branch || "",
              percentage: data.qualification?.percentage || "",
            },
            special_quota: data.special_quota || false,
            quota_category: data.quota_category || "",
            differently_abled: data.differently_abled || false,
            disability_category: data.disability_category || "",
            admission_status: data.admission_status || "Applied",
        ...
        setEmessage("Failed to load student data");
      } finally {
        setLoading(false);
      }
    };
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.data.success) {
        setSmessage(response.data.message || "Student updated successfully");
        setEmessage("");
        ...
        setTimeout(() => router.push(`/hod/students/view/${id}`), 1500);
        return;
      }
  ...
  return (
    <div className={styles.container}>
      <div className={styles.header}>
        <div>
          <p>Student Directory &gt; Edit Student</p>
        ...
        <div className={styles.actions}>
          <button
            ...
            type="button"
            onClick={() => router.push(`/hod/students/view/${id}`)}
          >
            Cancel
          </button>
      ...
      <form id="studentForm" onSubmit={handleSubmit}>
        ...
        <section className={styles.card}>
          ...
          <div className={styles.personalGrid}>
            <div className={styles.imageBox}>
              ...
              <p className={styles.imageUploadLabel}>Update Photo</p>
              <input
                ...
                <div className={styles.checkboxsub}>
                  ...
                  <label>
                    <input
                      ...
                      checked={formData.seven_point_five}
                      onChange={handleChange}
                    />{" "}
                    Yes
                  </label>
        ...
        <section className={styles.card}>
          <h2 className={styles.cardTitle}>
            {isRegular ? "Regular Admission Details" : "Lateral Entry Details"}
          </h2>
          <div className={styles.grid}>
            {isRegular ? (
              <>
                <div className={styles.fieldWrapper}>
                  ...
                  <input
                    ...
                    value={formData.qualification.emis_number}
                ...
                <div className={styles.fieldWrapper}>
                  ...
                  <input
                    ...
                    value={formData.qualification.qualifying_exam}
                    onChange={handleQualificationChange}
                    required
                  />
                </div>
                <div className={styles.fieldWrapper}>
                  ...
                  <input
                    ...
                    value={formData.qualification.passing_year}
                    onChange={handleQualificationChange}
                    required
                  />
                </div>
                <div className={styles.fieldWrapper}>
                  ...
                  <input
                    ...
                    value={formData.qualification.register_number}
                    onChange={handleQualificationChange}
                    required
                  />
                </div>
                <div className={styles.fieldWrapper}>
                  ...
                  <input
                    ...
                    value={formData.qualification.total_marks}
                    onChange={handleQualificationChange}
                    required
                  />
                </div>
                <div className={styles.fieldWrapper}>
                  ...
                  <input
                    ...
                    value={formData.qualification.mathematics_marks}
                    onChange={handleQualificationChange}
                  />
                </div>
                <div className={styles.fieldWrapper}>
                  ...
                  <input
                    ...
                    value={formData.qualification.physics_marks}
                    onChange={handleQualificationChange}
                  />
                </div>
                <div className={styles.fieldWrapper}>
                  ...
                  <input
                    ...
                    value={formData.qualification.chemistry_marks}
                    onChange={handleQualificationChange}
                  />
                </div>
                <div className={styles.fieldWrapper}>
                  ...
                  <input
                    ...
                    value={formData.qualification.aggregate}
                    onChange={handleQualificationChange}
                  />
                </div>
              </>
              ...
              <>
                <div className={styles.fieldWrapper}>
                  ...
                  <input
                    className={styles.formInput}
                    name="umis_number"
                    placeholder="UMIS Number"
                    value={formData.qualification.umis_number}
                    onChange={handleQualificationChange}
                    required
                  />
                </div>
                ...
                <div className={styles.fieldWrapper}>
                  ...
                  <input
                    ...
                    value={formData.qualification.diploma_branch}
                    onChange={handleQualificationChange}
                    required
                  />
                </div>
                ...
                <div className={styles.fieldWrapper}>
                  ...
                  <input
                    ...
                    value={formData.qualification.percentage}
                    onChange={handleQualificationChange}
                  />
                </div>
          ...
          <div className={styles.grid}>
            <div className={styles.fieldWrapper}>
              ...
              <select
                className={styles.formInput}
                name="special_quota"
                value={formData.special_quota ? "true" : "false"}
                onChange={(e) =>
                  setFormData((prev) => ({
                    ...prev,
                    special_quota: e.target.value === "true",
                  }))
                }
              >
            ...
            <div className={styles.fieldWrapper}>
              ...
              <input
                className={styles.formInput}
                name="quota_category"
                placeholder="Quota Category"
                value={formData.quota_category}
                onChange={handleChange}
              />
            </div>
            <div className={styles.fieldWrapper}>
              ...
              <select
                ...
                value={formData.differently_abled ? "true" : "false"}
                onChange={(e) =>
                  setFormData((prev) => ({
                    ...prev,
                    differently_abled: e.target.value === "true",
                  }))
                }
              >
                <option value="false">No</option>
